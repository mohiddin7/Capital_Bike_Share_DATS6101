...
```{r}
# Getting an overview of the "CaBi" data frame by displaying column data types and summary statistics.
sapply(CaBi, class)
...
```{r}
# Copying and converting "started_at" column to date format.
CaBiO <- CaBi
...
```{r}
# Bike Rental Demand by Season and Temperature
...
```{r}
# Boxplot showing the distribution of bike rentals by weather conditions.
...
```{r}
# Jitter Plot Showing Distribution of Bike Rentals by Weather Condition
ggplot() + 
